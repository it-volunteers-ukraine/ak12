...
VALUES
  (
    ...
    'https://157ombr.army/',
    '/images/subdivisions/157-omvr.webp',
  ...
  (
    ...
    'https://5brigade.army/',
    '/images/subdivisions/5-oshbr.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    20,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/65-ombr.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    30,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    '/images/subdivisions/72-ombr.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    40,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/67-ombr.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    50,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/209-optb.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    60,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    'https://428.org.ua/',
    '/images/subdivisions/428-obps.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    70,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/1027-zrap.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    80,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/2-omb-extremis.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    90,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/95-obp.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    100,
    (SELECT id FROM language WHERE code = 'uk')
  ...
  (
    ...
    NULL,
    '/images/subdivisions/524-oboo.webp',
    '/images/subdivisions/hover-image.webp',
    true,
    110,
    (SELECT id FROM language WHERE code = 'uk')
