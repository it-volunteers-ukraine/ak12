...
export const BlobButton = ({ href, children, typeStyles = "primary" }: BlobButtonProps) => {
  return (
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className="group relative flex h-10 w-50 scale-100 items-center justify-center focus:outline-none"
    >
      <svg
