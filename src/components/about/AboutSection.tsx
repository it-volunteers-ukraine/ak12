      ...
      <div className="container-app relative flex flex-col justify-between">
        ...
        <div className="tablet:py-10 desktop:py-14 flex w-full flex-col py-6">
          <div className="tablet:gap-[22px] tablet:mb-10 desktop:mb-14 mb-6 flex w-full flex-nowrap items-center gap-4">
            ...
            />
            <h2 className="font-ermilov text-accent tablet:text-[40px] tablet:leading-[120%] desktop:text-[56px] desktop:leading-[114%] desktop:text-primary-yellow-100 desktop:whitespace-nowrap text-left text-[28px] leading-[120%] font-bold">
              {mainTitle}
            </h2>
          </div>
          <div className="tablet:flex-row tablet:justify-between tablet:items-center tablet:gap-4 desktop:gap-6 desktop-xl:gap-[80px] flex w-full flex-col gap-8">
            <div className="tablet:w-[336px] tablet:shrink-0 laptop:w-[580px] desktop:w-[738px] desktop-xl:w-[870px] w-full">
              <div className="border-accent bg-surface-main tablet:p-8 tablet:h-[324px] laptop:h-auto desktop:h-[204px] desktop-xl:h-[176px] w-full rounded-[2px] border-l-4 p-5">
            ...
            <div
              className="tablet:block tablet:shrink-0 tablet:w-[280px] tablet:h-[280px] laptop:w-[380px] laptop:h-[280px] desktop:w-[446px] desktop:h-[334px] desktop-xl:w-[572px] desktop-xl:h-[428px] pointer-events-none relative hidden self-center select-none"
              aria-hidden="true"
            >
